...
test('RSS removes executable markup and preserves explicit dates',()=>{const r=parseFeed('<rss><channel><item><title>Dual-Use</title><link>https://www.bundestag.de/test</link><description><![CDATA[<b>Exportkontrolle</b>]]></description><pubDate>Mon, 07 Sep 2026 08:00:00 GMT</pubDate></item></channel></rss>',doc.url);assert.equal(r[0].text,'Exportkontrolle');assert.equal(r[0].documentType,'Behördenmeldung','kein Technikwort als Dokumenttyp');assert.equal(r[0].publishedAt,'2026-09-07T08:00:00.000Z');});

...
export default function Home(){
 ...
 {luecke!==null&&<div className="notice warnung" role="status"><Clock size={20}/><span><strong>Der letzte Abruf liegt {dauer(luecke)} zurück.</strong> Normalerweise läuft er alle 10 Minuten; der Taktgeber auf GitHub ist offenbar ins Stocken geraten. Neue Dokumente können deshalb fehlen. Ein Abruf von Hand startet ihn wieder.{REPO&&<> <a href={`https://github.com/${REPO}/actions/workflows/monitor.yml`} target="_blank" rel="noopener noreferrer">Abruf auf GitHub starten</a></>}</span></div>}
